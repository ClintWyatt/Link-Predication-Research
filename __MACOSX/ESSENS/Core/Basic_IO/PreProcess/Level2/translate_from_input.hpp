...
/*
first argument: network file
second argument: iput type - integer
third argument: output file
fourth argument: map file
*/
...
{	
	...
	switch (type)
	{ case 1:
			node_node_wt(file, gfile, mapfile); //goes to node_node_weight.hpp
            break;
	 case 2:
...
/*** Creates Map from nodes in mapfile to Actual Values ***/
/*differnt from previous create_map method in the first argument*/
